...
@implementation MadsNotificationCenterAdditions
...
+ (void)NC:(NSNotificationCenter*)notificationCenter postNotificationOnMainThreadWithName:(NSString*)name object:(id)object {
	...
	[MadsNotificationCenterAdditions NC:notificationCenter postNotificationOnMainThreadWithName:name object:object userInfo:nil waitUntilDone:NO];
}
...
+ (void)NC:(NSNotificationCenter*)notificationCenter postNotificationOnMainThreadWithName:(NSString*)name object:(id)object userInfo:(NSDictionary *)userInfo waitUntilDone:(BOOL)waitUntilDone {
	...
	[MadsNotificationCenterAdditions performSelectorOnMainThread:@selector(postNotificationDictionary:) withObject:info waitUntilDone:waitUntilDone];
